  ...
  try {
    ...
    for (const initial of techniques) {
      ...
      transitions.push(memory.transition({
        ...
        evidence: [
          ...
          {
            type: "human-review",
            reviewId: `fixture-trial-review-${current.id}`,
            reviewerId: "fixture-acceptance-reviewer",
            projectId: "fixture-acceptance-project",
            decision: "approved_for_trial",
            candidateId: current.id,
            evidenceSetHash: "e".repeat(64),
            technicalCatalogHash: "a".repeat(64),
            sourceCandidateContentHash: current.contentHash,
            trialCandidateContentHash: current.contentHash,
      ...
      transitions.push(memory.transition({
        ...
        evidence: [{
          ...
          reviewId: `fixture-real-clip-review-${current.id}`,
          decision: "approved",
    ...
    for (const initial of techniques) {
      ...
      finalTransitions.push(memory.transition({
        ...
        evidence: [{
          type: "real-clip-outcome-review",
          reviewId: `fixture-real-clip-final-review-${current.id}`,
          decision: "approved",
          perceptualDecision: "accept",
          reviewerId: "fixture-acceptance-reviewer",
          projectId: "fixture-project-one",
